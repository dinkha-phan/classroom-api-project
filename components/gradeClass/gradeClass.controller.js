...
router.put('/user/:userID/class/:classID/rank/:rank', async (req, res, next) => {
    const result = await gradeClassService.addOrEditGrade(req.params.classID, req.params.userID, req.params.rank, req.body.grade, req.body.tcCmt, req.body.stCmt, req.body.exGrade, req.body.status);
    res.json(result);
});
